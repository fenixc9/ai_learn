...
Same pattern each time. [Norbert Wiener](https://en.wikipedia.org/wiki/Cybernetics:_Or_Control_and_Communication_in_the_Animal_and_the_Machine) named it in 1948: cybernetics, from the Greek κυβερνήτης — steersman. You stop turning the valve. You steer.
